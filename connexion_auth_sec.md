...
|Serveurs Windows 2000/2003|Sortie du domaine les serveurs 2000/2003 car ils n'ont pas de mecanisme de sécurité permettant d'être compatible. Il risque de vous faire perdre le t1 très rapidement. Mieux vaut les isoler du domaine ou les réinstaller quand cela est possible (ex: partage de fichiers) ||
